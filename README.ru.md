...
headscale управляет тайлнетом, но общается с вами языком политики в HuJSON.
NodeRoost переводит это в понятия, которыми вы и так мыслите — серверы,
устройства, доступы, маршруты — и собирает политику за вас.
