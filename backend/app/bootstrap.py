...
log = logging.getLogger("noderoost.bootstrap")
...
async def ensure_admin(
    ...
    Break-glass: если NODEROOST_ADMIN_PASSWORD_RESET=1 — сбрасывает пароль на
    ...
    async with session_factory() as session:
        ...
        if user is None:
            ...
            log.warning(
                ...
                "NODEROOST_ADMIN_PASSWORD_RESET из .env и перезапустите"
            )
